...
R_B1 = @(alpha,beta,gamma)[...
   cos(alpha), -sin(alpha),          0;
    sin(alpha), cos(alpha), 0;
    0,          0, 1];

R_12 = @(alpha,beta,gamma)[...
   cos(beta), -sin(beta),          0;
    sin(beta), cos(beta), 0;
    0,          0, 1];
...
H_B1 = @(alpha,beta,gamma)[ R_B1(alpha,beta,gamma),       r_B1_inB;
         0, 0, 0,    1];
H_12 =@(alpha,beta,gamma) [ R_12(alpha,beta,gamma),       r_12_in1;
         0, 0, 0,    1];
H_23 = @(alpha,beta,gamma)[ R_23(alpha,beta,gamma),       r_23_in2;
         0, 0, 0,    1];

% create the cumulative transformation matrix
H_B3 =@(alpha,beta,gamma)(H_B1(alpha,beta,gamma)*H_12(alpha,beta,gamma)*H_23(alpha,beta,gamma)); 
